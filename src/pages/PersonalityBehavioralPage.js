    ...
    <Page title="Personality & Behavioral">
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box px={5} py={5} sx={{ display: "flex", alignItems: "center", bgcolor: "background.primary", borderRadius: "12px", width: { xs: "100%", md: "100%" } }}>
          ...
          <TextField name="questionCount" type="number" label="Interpersonal & Team-work Skills" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount1} onChange={(e) => setQuestionCount1(e.target.value)} />
          <TextField name="questionCount" type="number" label="Adaptability & Continuous Learning" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount2} onChange={(e) => setQuestionCount2(e.target.value)} />
          <TextField name="questionCount" type="number" label="Project & Time Management" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount3} onChange={(e) => setQuestionCount3(e.target.value)} />
          <TextField name="questionCount" type="number" label="Professional Etiquette & Interview Preparedness" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount4} onChange={(e) => setQuestionCount4(e.target.value)} />
