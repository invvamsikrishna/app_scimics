...
const AdminProfilePage = ({ account, common, authUpdated, getAllColleges, getAllCoursesById }) => {
...
export default connect(mapStateToProps, { authUpdated, getAllColleges, getAllCoursesById })(AdminProfilePage);