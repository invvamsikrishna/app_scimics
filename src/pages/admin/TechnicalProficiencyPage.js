              ...
              { queArray.length > 0 && isGenrated ? (
                  <>
                    { queArray.map((items, index) => {
                        // if (
                        //   (countDSK < questionCount1 && items.category === "Quantitative Aptitude") ||
                        //   (countHC < questionCount2 && items.category === "Coding Questions")
                        // ) {
                        //   if (items.category === "Quantitative Aptitude") {
                        //     countDSK++;
                        //     console.log(countDSK);
                        //   } else if (items.category === "Coding Questions") {
                        //     countHC++;
                        //     console.log(countHC);
                        //   }
                    ...
                    {(countDSK === 0 && generateAgainMessage) ||
                     (countHC === 0 && generateAgainMessage)}
                  </>
