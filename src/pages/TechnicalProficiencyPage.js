    ...
    <Page title="Technical Proficiency">
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box px={5} py={5} sx={{ display: "flex", alignItems: "center", bgcolor: "background.primary", borderRadius: "12px", width: { xs: "100%", md: "100%" } }}>
          ...
          <TextField name="questionCount" label="Domain-Specific" type="number" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount1} onChange={(e) => setQuestionCount1(e.target.value)} />
          <TextField name="questionCount" label="Hands-on Coding" type="number" sx={{ marginLeft: 3, marginRight: 3, width: "150px" }} value={questionCount2} onChange={(e) => setQuestionCount2(e.target.value)} />
